...
export class ComponentController {
  ...
  @Get('allSaveComponents/:appId')
  async getSaveComponents(@Param('appId') appId: string) {
    console.log("appId", appId);
    const compo = await this.componentService.getSaveComponents(appId);
    return compo;
  }
  ...
  @Put('app-save')
  async saveComponent(@Body() body: any) {
    const save = this.componentService.saveComponent(body);
    return save;
  }
